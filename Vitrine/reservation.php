                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="card-text"><strong>Prix :</strong> <?php echo $voitureSelectionnee['prix']; ?>
                                €/heure</li>
                            <li class="card-text"><strong>Année :</strong>
                                <?php echo htmlspecialchars($voitureSelectionnee['annee']); ?></li>
                            <li class="card-text"><strong>Carburant :</strong>
                                <?php echo htmlspecialchars($voitureSelectionnee['carburant']); ?></li>
                        </ul>
                        <form method="POST"
                            action="reservation.php?voiture=<?php echo urlencode($voitureSelectionnee['marque'] . ' ' . $voitureSelectionnee['modele']); ?>">
                            <div class="mb-3">
                                <label for="date_recuperation" class="form-label">Date de récupération</label>
                                <input type="date" id="date_recuperation" name="date_recuperation" class="form-control"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" name="confirmer" class="btn btn-dark">Confirmer votre
                                    réservation</button>
                            </div>
                        </form>
                    </div>
